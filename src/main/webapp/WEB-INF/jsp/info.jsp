			...
			<div class="page-header">
				<h1>
					<c:if test="${!empty mi.defName}">
						${mi.defName}
						<c:if test="${pd.isNew!=0 && !empty pd.isNew}">
							...
							<table class="table table-striped">
								...
								<tr>
									...
									<td><fmt:formatNumber type="number"
											value="${(((mi.hp*2 + 120) * 100/100 + 100 + 10 + 255/4)) - (((mi.hp*2 + 120) * 100/100 + 100 + 10 + 255/4)%1)
	}" /></td>
									<td><fmt:formatNumber type="number"
											value="${(((mi.atk*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1) -((((mi.atk*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1)%1)
	}" /></td>
									<td><fmt:formatNumber type="number"
											value="${(((mi.def*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1) - ((((mi.def*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1)%1)
	}" /></td>
									<td><fmt:formatNumber type="number"
											value="${(((mi.spAtk*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1) - ((((mi.spAtk*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1)%1)
	}" /></td>
									<td><fmt:formatNumber type="number"
											value="${(((mi.spDef*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1) - ((((mi.spDef*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1)%1)
	}" /></td>
									<td><fmt:formatNumber type="number"
											value="${(((mi.spd*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1) - ((((mi.spd*2 + 120) * 100/100 + 100 + 10 + 255/4) *1.1)%1)
	}" /></td>
								</tr>
								<tr>
