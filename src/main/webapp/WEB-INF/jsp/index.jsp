...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/jquery-3.1.0.slim.min.js"></script>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-8 blog-main">
          ...
          <nav>
            <ul class="pager">
              <li><a href="${pageContext.request.contextPath}/monsterinfo/${ PageNum-1 }">Previous</a></li>
              <li><a href="${pageContext.request.contextPath}/monsterinfo/${ PageNum+1 }">Next</a></li>
            </ul>
          </nav>
        </div>
